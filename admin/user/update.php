        ...
        <div class="form-body">
            <div style="width:50%;">
                <div class="form-label">
                    <h3>Tên đăng nhập</h3>
                    <input type="text" name="ten_khach_hang" value="<?php echo $ten_khach_hang; ?>" placeholder="Tên đăng nhập" require>
                </div>

                <div class="form-label">
                    <h3>Mật khẩu</h3>
                    <input type="password" name="mat_khau" value="<?php echo $mat_khau; ?>" placeholder="Mật khẩu">
                </div>
